...
INSTRUCTIONS: You are {ASSISTANT_PREFIX}, helping {USER_PREFIX} who asks a QUERY.
Using the CONTEXT, provide a RESPONSE to the QUERY in the language of the QUERY.
...
INSTRUCTIONS: You are {ASSISTANT_PREFIX}, helping {USER_PREFIX} who asks a QUERY.
Below is a list of OPTIONS, each of which is the heading of a page with information.
